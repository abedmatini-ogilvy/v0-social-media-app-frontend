      ...
      <div className="container mx-auto px-4 py-6">
        ...
        {isSearching ? (
          ...
          <Tabs defaultValue="all" className="w-full">
            <TabsList className="grid grid-cols-5 mb-6 bg-purple-100 p-1">
              ...
              <TabsTrigger
                ...
                className="data-[state=active]:bg-white data-[state=active]:text-purple-700"
              >
                Officials ({results.users.length})
              </TabsTrigger>
              <TabsTrigger
                value="events"
                className="data-[state=active]:bg-white data-[state=active]:text-purple-700"
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                  {results.schemes.length > 0 && (
                    <Card className="border-purple-100">
                      ...
                      <CardContent className="space-y-4">
                        {results.schemes.slice(0, 2).map(renderSchemeCard)}
                      </CardContent>
                    </Card>
                  )}
                  {results.users.length > 0 && (
                    <Card className="border-purple-100">
                      ...
                      <CardContent className="space-y-4">
                        {results.users.slice(0, 2).map(renderUserCard)}
                      </CardContent>
                    </Card>
                  )}
                  {results.events.length > 0 && (
                    <Card className="border-purple-100">
                      ...
                      <CardContent className="space-y-4">
                        {results.events.slice(0, 2).map(renderEventCard)}
                      </CardContent>
                    </Card>
                  )}
                  {results.posts.length > 0 && (
                    <Card className="border-purple-100">
                      ...
                      <CardContent className="space-y-4">
                        {results.posts.slice(0, 2).map(renderPostCard)}
                      </CardContent>
                    </Card>
                  )}
                </div>
          ...
          <div className="text-center py-12">
            ...
            <p className="mt-2 text-gray-500">
              Enter a search term to find schemes, officials, events, or
              community posts.
            </p>
          </div>
        )}
