...
export default function AdminDashboardPage() {
  ...
  const fetchData = useCallback(async () => {
    ...
    setLoading(true);
    try {
      const [statsData, usersData, reportsData, announcementsData, eventsData] =
        await Promise.all([
              ...
              <div className="flex items-center space-x-2">
                ...
                <DropdownMenu>
                  ...
                  <DropdownMenuContent align="end">
                    ...
                    <DropdownMenuSeparator />
                    <DropdownMenuItem>
                      <Link href="/">Back to More & More Network</Link>
                    </DropdownMenuItem>
                    <DropdownMenuSeparator />
              ...
              <div className="space-y-6">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4">
                  ...
                  <Card className="border-purple-100 dark:border-purple-900">
                    ...
                    <CardContent>
                      <div className="text-3xl font-bold">
                        {stats?.verifiedOfficials?.toLocaleString() || 0}
                      </div>
                  ...
                  <Card className="border-purple-100 dark:border-purple-900">
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-green-600 dark:text-green-400 mt-1">
                        +{stats?.newPostsToday || 0} new today
                      </p>
                    </CardContent>
                  </Card>
                  ...
                  <Card className="border-purple-100 dark:border-purple-900">
                    ...
                    <CardContent>
                      ...
                      <p className="text-sm text-red-600 dark:text-red-400 mt-1">
                        {stats?.bannedUsers || 0} users banned
                      </p>
                    </CardContent>
                  </Card>
                </div>
                    ...
                    <CardContent>
                      <ScrollArea className="h-[300px]">
                        <div className="space-y-4">
                          ...
                          {users.filter(
                            (u) => u.role === "official" && !u.isVerified
                          ).length > 0 && (
                                  ...
                                  <p className="text-sm text-orange-700 dark:text-orange-300 mt-1">
                                    {
                                      users.filter(
                                        (u) =>
                                          u.role === "official" && !u.isVerified
                                      ).length
                                    }{" "}
                                    officials waiting for verification
                                  </p>
                                </div>
                  ...
                  <Card className="border-purple-100 dark:border-purple-900">
                    <CardContent className="p-8 text-center">
                      ...
                      <p className="text-sm text-gray-400 dark:text-gray-500 mt-1">
                        {reportFilter === "all"
                          ? "There are no content reports yet."
            ...
            {activeTab === "verification" && (
              <div className="space-y-6">
                ...
                {users.filter((u) => u.role === "official" && !u.isVerified)
                  ...
                  <div className="space-y-4">
                    {users
                      .filter((u) => u.role === "official" && !u.isVerified)
                      .map((user) => (
                        <Card
                          key={user.id}
                          className="border-purple-100 dark:border-purple-900"
              ...
              <div className="space-y-6">
                ...
                <Card className="border-purple-100 dark:border-purple-900">
                  <CardHeader>
                    ...
                    <CardDescription>
                      Create and publish announcements to citizens
                    </CardDescription>
                  </CardHeader>
                  ...
                  <CardHeader>
                    ...
                    <CardDescription>
                      {editingEvent
                        ...
                        : "Create community events for citizens to attend"}
                    </CardDescription>
                  </CardHeader>
                  <CardContent className="space-y-4">
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                          ...
                          >
                            ...
                            <div className="flex gap-2">
                              <Button
                                ...
                                variant="outline"
                                onClick={() =>
                                  handleViewAttendees(event.id, event.title)
                                }
                ...
                {viewingAttendees && (
                  <Card className="border-purple-100 dark:border-purple-900">
                    <CardHeader className="flex flex-row items-center justify-between">
                      <div>
                        <CardTitle>
                          Attendees for "{viewingAttendees.eventTitle}"
                        </CardTitle>
                        <CardDescription>
                          {viewingAttendees.attendees.length} registered
                          attendees
                        </CardDescription>
                      </div>
                      <Button
                            ...
                            {viewingAttendees.attendees.map((attendee) => (
                              ...
                              >
                                <Avatar className="h-10 w-10">
                                  <AvatarImage
                                    src={
                                      attendee.user.avatar || "/placeholder.svg"
                                    }
                ...
                <Card className="border-purple-100 dark:border-purple-900">
                  ...
                  <CardContent className="space-y-4">
                    <div className="space-y-2">
                      ...
                      <Input
                        defaultValue="More & More Network"
                        className="border-purple-200 dark:border-purple-900"
                      />
                    </div>
                  ...
                  <CardContent className="space-y-4">
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Enable automatic content moderation for posts and
                          comments
                        </p>
                      </div>
                      <Switch defaultChecked />
                    ...
                    <div className="flex items-center justify-between">
                      <div>
                        ...
                        <p className="text-sm text-gray-500 dark:text-gray-400">
                          Automatically log out inactive admin users after a
                          period of time
                        </p>
                      </div>
